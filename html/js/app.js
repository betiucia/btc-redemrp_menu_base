(function () {
    let MenuTpl =
        ...
        '<img style="width: 30px ;height: 30px;background-image: url(nui://btc-redemrp_menu_base/html/slot-bk.png);background-blend-mode: screen;background-repeat: round;align-content: center;padding: 10px;" src={{{src}}}>' +
        ...
        ;
    window.MenuData = {};
    MenuData.ResourceName = 'btc-redemrp_menu_base';
    MenuData.opened = {};
    MenuData.focus = [];
    MenuData.pos = {};
    let lastmenu;
