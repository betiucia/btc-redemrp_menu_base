...
RegisterNUICallback('menu_change', function(data)
    ...
    if menu.change ~= nil then
        menu.change(data, menu) -- Tava com bug então tirei BETIUCIA
    end
end)
...
RegisterNUICallback('closeui', function(data)
    TriggerEvent("btc-redemrp_menu_base:closemenu")
end)

AddEventHandler('btc-redemrp_menu_base:getData', function(cb)
    cb(MenuData)
end)
